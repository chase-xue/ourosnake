...
* **LV1 萌态 · 肥蛇**（1~19 节）：圆润憨萌，网格宽阔，给玩家充分的初期游走与操作熟悉时间。
* **LV2 进阶 · 灵动**（20~49 节）：身姿矫健，速度加快，中段挑战感提升。
* **LV3 优雅 · 修长**（50~89 节）：网格进一步密致，翡翠与极光蓝流光渐变，极其考验走位。
* **LV4 终极 · 神龙**（90+ 节）：38 阶微细网格，傲视全场的赛博神龙，终极荣耀成就！
...
```javascript
// 4 阶形态配置：进阶阈值大幅提升，延长前期与中后期的深度游玩时间
const STAGES = [
